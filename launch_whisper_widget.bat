...
"%PYTHON_EXE%" -c "import importlib.metadata as m, customtkinter, whisper, pyaudio, keyboard, pyperclip, torch, torchaudio, numpy; m.version('openai-whisper')" >nul 2>nul
