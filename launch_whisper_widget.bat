...
"%PYTHON_EXE%" -c "import importlib.metadata as m, customtkinter, whisper, pyaudio, keyboard, torch, torchaudio, numpy, fastapi, uvicorn, multipart; m.version('openai-whisper')" >nul 2>nul
